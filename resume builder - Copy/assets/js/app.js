...
const getUserInputs = () => {
    ...
    expCertificateElem = document.querySelectorAll('.exp_certificate');
    ...
    expCertificateElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Cetrificate')));
    ...
    return {
        ...
        experiences: fetchValues(['exp_title', 'exp_organization', 'exp_location', 'exp_start_date', 'exp_end_date', 'exp_description','exp_certificate'], expTitleElem, expOrganizationElem, expLocationElem, expStartDateElem, expEndDateElem, expDescriptionElem,expCertificateElem),
